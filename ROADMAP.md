...
2. Continue ADR 0005 beyond the now-implemented divider and quote families: add richer slide families and a reusable layout library so common requests such as photo and split-photo slides map to validated structured specs and shareable JSON layout definitions.
