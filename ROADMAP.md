...
1. apply the pragmatic UI review by keeping Slide Studio anchored around preview, slide selection, and variant generation before lower-frequency context and slide-management controls
