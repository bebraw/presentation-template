...
- Saved layouts have a portable JSON exchange document shape plus server import/export endpoints for deck-local and favorite libraries, with duplicate imported ids normalized before save.
