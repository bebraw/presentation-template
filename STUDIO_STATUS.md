...
- Initial presentation generation now requires titled key points, rejects leaked schema labels, filters unsupplied reference URLs, blocks bibliographic-looking invented citations, and keeps weak-model outputs from writing obviously placeholder-like slide text.
