...
2. Continue ADR 0005 beyond the now-implemented divider, quote, photo, deck-local/favorite layout library, and library-backed layout candidates: add generated layout-definition workflows and richer slide families so common requests such as split-photo slides map to validated structured specs and shareable JSON layout definitions.
