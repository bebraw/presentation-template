...
Not implemented yet:
- repo-aware deck-level workflows beyond inserted-slide scaffolding, scaffolded replacement, reordering, title promotion, and metadata-backed structure planning

## Next Focus

The next practical slice should deepen the deck-level workflow surface now that inserted-slide scaffolding and replacement are in place:

1. extend deck-level structure planning from scaffolded insert and replace into guarded remove operations or richer compose flows
...
- deck-level presentation-structure ideation through both the browser UI and the assistant, with safe apply back to the saved outline, per-slide structure metadata, promoted slide titles, slide reordering, inserted slide scaffolds, and scaffolded slide replacement
...
- repo-aware deck-level workflow operations beyond inserted-slide scaffolding, scaffolded replacement, reordering, title promotion, and metadata-backed structure planning
