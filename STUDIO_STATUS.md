...
- Redo Layout can use LLM mode for intent-only family-changing candidates; local validated transforms build the actual slide specs from target-family, dropped-field, preserved-field, emphasis, and rationale metadata before preview/apply.
