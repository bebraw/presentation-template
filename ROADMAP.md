...
2. Continue ADR 0005 beyond the now-implemented divider, quote, and photo families: add richer slide families and a reusable layout library so common requests such as split-photo slides map to validated structured specs and shareable JSON layout definitions.
