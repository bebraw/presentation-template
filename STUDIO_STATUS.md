...
- Presentation selection uses visual first-slide cards with the presentation name, compact metadata facts, active state, search/filter, regeneration, duplication, and deletion controls.
