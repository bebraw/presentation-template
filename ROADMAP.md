...
2. Continue ADR 0005 beyond the now-implemented divider, quote, photo, and deck-local layout-library foundation: add richer slide families and favorite/generated layout workflows so common requests such as split-photo slides map to validated structured specs and shareable JSON layout definitions.
